"""
Django settings for Wonderful world of Cereals project.
...
WSGI_APPLICATION = 'cereals.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'cereals.db'),
    }
}
